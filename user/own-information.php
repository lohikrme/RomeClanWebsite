...
<div class="textArea4">
    ...
    <p>Ps. Our website is still a bit in the demo phase. We will add this functionality later. 
        If you get issues with changing your name, email or password, please contact rome.lh.bl@gmail.com</p>
    <div class="own-info">
        <br>
        <table>
            <tr>
